Pod::Spec.new do |s|
    ...
    s.platform     = :ios, "10.0"
    s.source       = { :http => "https://github.com/jorgepalac1o/klarna-ios/releases/download/3.0.1/KlarnaMobileSDK.zip" }
    s.requires_arc = true
    s.swift_version = "5.0"

    s.subspec 'full' do |sb|
        sb.vendored_frameworks = "Frameworks/KlarnaMobileSDK.xcframework", "Frameworks/KlarnaCore.xcframework"
    end
